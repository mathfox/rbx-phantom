// source: https://github.com/KamilHs/type-samurai/blob/79490c1d7eb919761b6d70683f67f0588614841b/src/min.d.ts
 ...
 * ```
 */
export type Min<Num1 extends number, Num2 extends number> = IfLowerThan<Num1, Num2, Num1, Num2>;
...
> = IsEmptyArray<T> extends true
	? CurrentMin
	: Shift<T, { includeRemoved: true }> extends [infer Rest extends number[], infer First extends number]
