// source: https://github.com/KamilHs/type-samurai/blob/79490c1d7eb919761b6d70683f67f0588614841b/src/array.d.ts
 ...
 * ```
 */
export type EmptyArray<T extends readonly unknown[]> = T extends readonly [unknown, ...unknown[]] ? never : T;
 ...
 * ```
 */
export type NonEmptyArray<T extends readonly unknown[]> = If<IsNever<EmptyArray<T>>, T, never>;
 ...
 */
export type IsEmptyArray<T extends readonly unknown[]> = If<IsNever<EmptyArray<T>>, false, true>;
 ...
 * type Result - IsEmptyArray<[1]>
 */
export type IsNonEmptyArray<T extends readonly unknown[]> = If<IsNever<EmptyArray<T>>, true, false>;
 ...
 * ```
 */
export type IfEmptyArray<T extends readonly unknown[], IfTrue = true, IfFalse = false> = If<
	IsEmptyArray<T>,
	IfTrue,
	IfFalse
>;
 ...
 * ```
 */
export type IfNonEmptyArray<T extends readonly unknown[], IfTrue = true, IfFalse = false> = If<
	IsNonEmptyArray<T>,
	IfTrue,
	IfFalse
>;
