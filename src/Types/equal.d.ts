// source: https://github.com/KamilHs/type-samurai/blob/79490c1d7eb919761b6d70683f67f0588614841b/src/equal.d.ts
 ...
 * ```
 */
export type IsEqual<T, U> = (<F>() => F extends T ? 1 : 2) extends <F>() => F extends U ? 1 : 2 ? true : false;
 ...
 * ```
 */
export type IfEqual<T, U, IfTrue = true, IfFalse = false> = If<IsEqual<T, U>, IfTrue, IfFalse>;
 ...
 * ```
 */
export type IfNotEqual<T, U, IfTrue = true, IfFalse = false> = If<IsNotEqual<T, U>, IfTrue, IfFalse>;
