// source: https://github.com/KamilHs/type-samurai/blob/79490c1d7eb919761b6d70683f67f0588614841b/src/unknown.d.ts
 ...
 * ```
 */
export type IfUnknown<T, IfTrue = true, IfFalse = false> = If<IsUnknown<T>, IfTrue, IfFalse>;
