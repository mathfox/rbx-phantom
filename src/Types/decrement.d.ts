// source: https://github.com/KamilHs/type-samurai/blob/79490c1d7eb919761b6d70683f67f0588614841b/src/decrement.d.ts
...
export type _Decrement<Number extends string, Result extends string = ""> = Number extends ""
	? ParseNumber<Result>
...
type _DecrementNegativeOrZero<T extends number> = _Increment<Stringify<T>> extends infer PositiveDecrementResult extends
	number
