// source: https://github.com/KamilHs/type-samurai/blob/79490c1d7eb919761b6d70683f67f0588614841b/src/reverse.d.ts

import { IsEmptyArray } from "./array";
import { IsReadonlyArray } from "./is-array";
import { IsTuple } from "./is-tuple";

type _Reverse<T extends readonly unknown[], Result extends readonly unknown[] = []> = IsEmptyArray<T> extends true
	? Result
