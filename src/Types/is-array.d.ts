// source: https://github.com/KamilHs/type-samurai/blob/79490c1d7eb919761b6d70683f67f0588614841b/src/is-array.d.ts
 ...
 * ```
 */
export type IsArray<T> = AndArr<[Not<IsAny<T>>, Not<IsNever<T>>, Extends<T, readonly unknown[]>]>;
