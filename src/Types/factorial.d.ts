// source: https://github.com/KamilHs/type-samurai/blob/79490c1d7eb919761b6d70683f67f0588614841b/src/factorial.d.ts
...
type _Factorial<T extends number, CurrentNum extends number = 1, CurrentProduct extends number = 1> = IsEqual<
	T,
	CurrentNum
> extends true
