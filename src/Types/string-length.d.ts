// source: https://github.com/KamilHs/type-samurai/blob/79490c1d7eb919761b6d70683f67f0588614841b/src/string-length.d.ts
		...
		? Rest1 extends `${infer C2 extends string}${infer Rest2 extends string}`
			? Rest2 extends `${infer C3 extends string}${infer Rest3 extends string}`
				? Rest3 extends `${infer C4 extends string}${infer Rest4 extends string}`
					? _StringLength<Rest4, [[...Parts[0], C1], [...Parts[1], C2], [...Parts[2], C3], [...Parts[3], C4]]>
					: _StringLength<Rest3, [[...Parts[0], C1], [...Parts[1], C2], [...Parts[2], C3], Parts[3]]>
 ...
 * ```
 */
export type IsShorterString<Str1 extends string, Str2 extends string> = CompareStringLength<
	Str1,
	Str2,
	true,
	false,
 ...
 * ```
 */
export type IsLongerString<Str1 extends string, Str2 extends string> = CompareStringLength<
	Str1,
	Str2,
	false,
	true,
 ...
 * ```
 */
export type IsSameLengthString<Str1 extends string, Str2 extends string> = CompareStringLength<
	Str1,
	Str2,
	false,
	false,
