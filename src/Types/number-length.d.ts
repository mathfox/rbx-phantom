// source: https://github.com/KamilHs/type-samurai/blob/79490c1d7eb919761b6d70683f67f0588614841b/src/number-length.d.ts
...
export type CompareNumberLength<
	...
	IfNum2Shorter = never,
	IfEqual = never,
> = CompareStringLength<Stringify<Num1>, Stringify<Num2>, IfNum1Shorter, IfNum2Shorter, IfEqual>;
 ...
 * ```
 */
export type IsShorterNumber<Num1 extends number, Num2 extends number> = CompareNumberLength<
	Num1,
	Num2,
	true,
	false,
 ...
 * ```
 */
export type IsLongerNumber<Num1 extends number, Num2 extends number> = CompareNumberLength<
	Num1,
	Num2,
	false,
	true,
 ...
 * ```
 */
export type IsSameLengthNumber<Num1 extends number, Num2 extends number> = CompareNumberLength<
	Num1,
	Num2,
	false,
	false,
