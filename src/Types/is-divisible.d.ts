// source: https://github.com/KamilHs/type-samurai/blob/79490c1d7eb919761b6d70683f67f0588614841b/src/is-divisible.d.ts
 ...
 * ```
 */
export type IsDivisibleBySix<T extends number> = And<IsDivisibleByTwo<T>, IsDivisibleByThree<T>>;
 ...
 * ```
 */
export type IsDivisible<Dividend extends number, Divisor extends number> = IsEqual<Mod<Dividend, Divisor>, 0>;
