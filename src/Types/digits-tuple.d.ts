// source: https://github.com/KamilHs/type-samurai/blob/79490c1d7eb919761b6d70683f67f0588614841b/src/digits-tuple.d.ts
...
export type DigitsTuple<T extends number> = number extends T
	...
	: Split<Stringify<Abs<T>>, ""> extends infer Result
		? {
				[K in keyof Result]: Result[K] extends string ? ParseNumber<Result[K]> : Result[K];
			}
		: never;
