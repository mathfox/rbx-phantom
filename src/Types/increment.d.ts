// source: https://github.com/KamilHs/type-samurai/blob/79490c1d7eb919761b6d70683f67f0588614841b/src/increment.d.ts
...
export type _Increment<Number extends string, Result extends string = ""> = IsEmptyString<Number> extends true
