// source: https://github.com/KamilHs/type-samurai/blob/79490c1d7eb919761b6d70683f67f0588614841b/src/sub.d.ts
					...
					? Num1 extends `${infer Num1Rest}${Num1LastDigit}`
						? Num2 extends `${infer Num2Rest}${Num2LastDigit}`
							? DigitsSubWithCarry extends keyof SubNegativeCarryMap
								? _Sub<Num1Rest, Num2Rest, 1, `${SubNegativeCarryMap[DigitsSubWithCarry]}${Result}`>
 ...
 * ```
 */
export type Sub<Num1 extends number, Num2 extends number> = IsNegativeInteger<Num1> extends true
