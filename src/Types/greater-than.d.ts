// source: https://github.com/KamilHs/type-samurai/blob/79490c1d7eb919761b6d70683f67f0588614841b/src/greater-than.d.ts
 ...
 * ```
 */
export type IsGreaterThan<Num1 extends number, Num2 extends number> = IsLowerThan<Num2, Num1>;
 ...
 * ```
 */
export type IfGreaterThan<Num1 extends number, Num2 extends number, IfTrue = true, IfFalse = false> = IfLowerThan<
	Num2,
	Num1,
	IfTrue,
	IfFalse
 ...
 * ```
 */
export type IsGreaterOrEqual<Num1 extends number, Num2 extends number> = IsEqual<Num1, Num2> extends true
	? true
 ...
 * ```
 */
export type IfGreaterOrEqual<Num1 extends number, Num2 extends number, IfTrue = true, IfFalse = false> = If<
