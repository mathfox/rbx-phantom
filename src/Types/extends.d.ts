// source: https://github.com/KamilHs/type-samurai/blob/79490c1d7eb919761b6d70683f67f0588614841b/src/extends.d.ts
 ...
 * ```
 */
export type IfExtends<T, Base, IfTrue = true, IfFalse = false> = If<Extends<T, Base>, IfTrue, IfFalse>;
 ...
 * ```
 */
export type IfNotExtends<T, Base, IfTrue = true, IfFalse = false> = If<NotExtends<T, Base>, IfTrue, IfFalse>;
